...
public class FD_MM extends JFrame implements ActionListener {
	/**
	...
	JComboBox jComboBox1 = new JComboBox();
	  public FD_MM() throws HeadlessException {
	    try {
	      jbInit();
	    }
	    catch(Exception e) {
		   ...
		   if (boutonCliqué == jButton1){
			   if (st1.isEmpty()){JOptionPane.showConfirmDialog(null,
				   ...
				   JOptionPane.showConfirmDialog(null,
					   ...
					   JOptionPane.showConfirmDialog(null,
					   ...
					   else {Execute2 EX = new Execute2 (); try {
							v = EX.modifier_user(st1, st2, st3,st4);
							
							if (v==1){JOptionPane.showConfirmDialog(null,
									"Modification du mot de passe réussi",
									"Juste un test",
									JOptionPane.PLAIN_MESSAGE);
							jTextField1.setText("");
							jPasswordField1.setText("");
							jPasswordField2.setText("");}
								...
								if (v==0){{JOptionPane.showConfirmDialog(null,"Vous avez essayer de modifier un utilisateur"+" \n qui n'existe pas ",
									"Juste un test",
									JOptionPane.PLAIN_MESSAGE);
								jTextField1.setText("");
									jPasswordField1.setText("");
